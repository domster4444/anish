          ...
          <div className="contentBlock">
            <main>
              ...
              <div className="container">
                <SidePricingCard
                  priceTag={isAnnual === true ? "Rs. 15,000" : "Rs. 1,250"}
                  title="For Standard Use"
                  priceAmount={isAnnual === true ? 15000 : 1250}
                >
                  <>
                    <ul>
                      <li className="pricing_feature_list">
                        <Tooltip
                          message={
                            "Indicates total due amount of the school! This data is sum of all resource the software is using"
                          }
                        >
                          ...
                          <div className="pricing_feature_list_point">
                            Up to 300 students
                          </div>
                        </Tooltip>
                      </li>
                ...
                <CenterPricingCard
                  priceTag={isAnnual === true ? "Rs. 24000" : "Rs. 2000"}
                  title="For Premium Use"
                  priceAmount={isAnnual === true ? 24000 : 2000}
                >
                  <ul>
                ...
                <SidePricingCard
                  priceTag={isAnnual === true ? "Rs. 18,000" : "Rs. 1,500"}
                  title="For Ultimate Use"
                  priceAmount={isAnnual === true ? 18000 : 1500}
                >
                  <ul>
                    <li className="pricing_feature_list">
                      <Tooltip
