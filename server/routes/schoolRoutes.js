...
router.route("/school-register").post(upload.single("image"), registerSchoolController);
router.route("/school-login").post(upload.none(), loginSchoolController);
router.route("/update-school/:id").put(upload.single("image"), updateSchoolController);
